...
class KnowledgeSignalServiceTest {
    ...
    private JdbcTemplate jdbc() {
        ...
        jdbc.execute("CREATE TABLE raw_messages (id BIGINT PRIMARY KEY, account_id BIGINT, chat_title TEXT, sender_name TEXT, sender_id BIGINT, sender_username TEXT, message_date TIMESTAMP WITH TIME ZONE, telegram_chat_id BIGINT, telegram_message_id BIGINT, message_thread_id BIGINT, text TEXT, caption TEXT)");
        jdbc.execute("CREATE TABLE dataset_messages (id BIGINT PRIMARY KEY, account_id BIGINT, telegram_chat_id BIGINT, telegram_message_id BIGINT, chat_title TEXT, sender_name TEXT, sender_id BIGINT, sender_username TEXT, message_date TIMESTAMP WITH TIME ZONE, text TEXT, caption TEXT)");
        ...
        jdbc.execute("CREATE TABLE knowledge_items (id BIGINT PRIMARY KEY, status TEXT, artifact_type TEXT, title TEXT, body_json JSONB, knowledge_value_score NUMERIC, source_cluster_type TEXT, deleted_at TIMESTAMP WITH TIME ZONE)");
        jdbc.execute("CREATE TABLE knowledge_item_sources (knowledge_item_id BIGINT NOT NULL, raw_message_id BIGINT, dataset_message_id BIGINT, contribution TEXT, PRIMARY KEY (knowledge_item_id, raw_message_id, dataset_message_id))");
        ...
        jdbc.execute("CREATE TABLE knowledge_signal_sources (signal_id BIGINT NOT NULL, raw_message_id BIGINT, dataset_message_id BIGINT, text TEXT, sender_id BIGINT, sender_name TEXT, message_date TIMESTAMP WITH TIME ZONE, created_at TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), PRIMARY KEY (signal_id, raw_message_id, dataset_message_id))");
        jdbc.update("INSERT INTO raw_messages (id, account_id, chat_title, sender_name, sender_id, sender_username, message_date, telegram_chat_id, telegram_message_id, message_thread_id, text, caption) VALUES (15541, 1, 'Vibecoder Chat [Public]', 'LarryParry', 555, 'LarryParry', now(), -1002922797592, 141629063168, 127903, '7 млн токенов в сутки дают тут на бесплатные модели Сюда тыкай https://router.bynara.id/register?ref=5RWD9UQV', null)");
        jdbc.update("INSERT INTO dataset_messages (id, account_id, telegram_chat_id, telegram_message_id, chat_title, sender_name, sender_id, sender_username, message_date, text, caption) VALUES (14172, 1, -1002922797592, 141629063168, 'Vibecoder Chat [Public]', 'LarryParry', 555, 'LarryParry', now(), '7 млн токенов в сутки дают тут на бесплатные модели Сюда тыкай https://router.bynara.id/register?ref=5RWD9UQV', null)");
